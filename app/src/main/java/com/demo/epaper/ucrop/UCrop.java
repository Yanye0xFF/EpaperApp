...
import com.demo.epaper.activity.UCropActivity;
...
public class UCrop {
    ...
    public static class Options {
        ...
        public static final String EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE = "UcropColorControlsWidgetActive";
