package com.demo.epaper.view.discreteseekbar.internal;
...
public class Marker extends ViewGroup implements MarkerDrawable.MarkerAnimationListener {
    ...
    public Marker(Context context, AttributeSet attrs, int defStyleAttr, String maxValue, int thumbSize, int separation) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.DiscreteSeekBar,
    ...
    public void resetSizes(String maxValue) {
        ...
        removeView(mNumber);
        addView(mNumber, new FrameLayout.LayoutParams(mWidth, mWidth, Gravity.START | Gravity.TOP));
    }
