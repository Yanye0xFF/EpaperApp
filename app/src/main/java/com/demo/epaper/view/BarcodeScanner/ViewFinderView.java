...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private void init(Context context) {
        int mDefaultLaserColor = ContextCompat.getColor(context, R.color.viewfinder_laser);
        int mDefaultMaskColor = ContextCompat.getColor(context, R.color.viewfinder_border);
        int mDefaultBorderColor = ContextCompat.getColor(context, R.color.viewfinder_mask);

        int mDefaultBorderStrokeWidth = 4;
        int mDefaultBorderLineLength = 60;
