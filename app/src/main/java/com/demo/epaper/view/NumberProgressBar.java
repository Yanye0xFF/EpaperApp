...
import com.demo.epaper.handler.OnProgressBarListener;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int default_text_color = Color.rgb(66, 145, 241);
        final int default_reached_color = Color.rgb(66, 145, 241);
        final int default_unreached_color = Color.rgb(204, 204, 204);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawReachedBar) {
            canvas.drawRoundRect(mReachedRectF, 5,5,  mReachedBarPaint);
        }

        if (mDrawUnreachedBar) {
            canvas.drawRoundRect(mUnreachedRectF, 5,5, mUnreachedBarPaint);
        }
    ...
    private void calculateDrawRectF() {
        ...
        mCurrentDrawText = String.format(Locale.CHINA, "%d", getProgress() * 100 / getMax());
