...
import com.demo.epaper.ucrop.callback.BitmapCropCallback;
import com.demo.epaper.ucrop.model.AspectRatio;
import com.demo.epaper.ucrop.util.SelectedStateListDrawable;
import com.demo.epaper.ucrop.view.CropImageView;
import com.demo.epaper.ucrop.view.GestureCropImageView;
import com.demo.epaper.ucrop.view.OverlayView;
import com.demo.epaper.ucrop.view.TransformImageView;
import com.demo.epaper.ucrop.view.UCropView;
import com.demo.epaper.ucrop.view.widget.AspectRatioTextView;
import com.demo.epaper.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setupViews(@NonNull Intent intent) {
        mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, ContextCompat.getColor(this, R.color.color_primary_variant));
        mToolbarColor = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR, ContextCompat.getColor(this, R.color.color_primary));
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.color_primary_variant));
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        for (ViewGroup cropAspectRatioView : mCropAspectRatioViews) {
            cropAspectRatioView.setOnClickListener((View v) -> {
                mGestureCropImageView.setTargetAspectRatio(
                        ((AspectRatioTextView) ((ViewGroup) v).getChildAt(0)).getAspectRatio(v.isSelected()));
                mGestureCropImageView.setImageToWrapCropBounds();
                if (!v.isSelected()) {
                    for (ViewGroup group : mCropAspectRatioViews) {
                        cropAspectRatioView.setSelected(group == v);
                    }
                }
    ...
    private void setupRotateWidget() {
        ...
        findViewById(R.id.wrapper_reset_rotate).setOnClickListener((View view) ->  resetRotation());
        findViewById(R.id.wrapper_rotate_by_angle).setOnClickListener((View view) -> rotateByAngle(90));
    ...
    private final View.OnClickListener mStateClickListener = (View view) -> {
        if (!view.isSelected()) {
